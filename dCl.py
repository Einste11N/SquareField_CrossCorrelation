...
class Cl_kSZ2_HI2():
    ...
    def __init__(self, z_array, Tb = 1.8e-4, H0 = 67.75, ombh2 = 0.022):
        ...
        self.SIGMA_KSZ = deepcopy(SIGMA_HI)
    ...
    def Power_matter_1d(self, zindex, Mode='cubic'):
        return interp1d(self.kh_array_itp, (self.Pm_itp)[zindex], kind=Mode)
    ...
    def dchi_by_dz(self, z):
        return 1 / self.H_of_z(z)

    def Beam_kSZ(self, l):
        return tc.exp(-l**2 * self.singma_kSZ**2 / 2)
    
    def Beam_HI(self, l):
        return tc.exp(-l**2 * self.singma_HI**2 / 2)
    ...
    def dCl_slow(self, z, l, l1, l_min = 1, l_max = 1000, N_l = 1000, N_theta = 81):
        """Evaluare the integrand, dCl, as a function of z, l and l_1.
